...
const FollowUs = () => {
  return (
    <div className="bg-gray-50 space-y-4 mt-16 pt-10 pb-10">
      ...
      <h2 className="text-center text-3xl font-bold pt-4">HOW CAN WE HELP?</h2>
      ...
      <div className="flex justify-center items-center gap-6">
        <button className="btn bg-[#f7943c] text-white">FIND A TOUR</button>
        <button className="btn bg-[#f7943c] text-white">CONTACT US</button>
      </div>
    </div>
  );
};
